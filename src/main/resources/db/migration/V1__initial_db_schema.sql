...
VALUES
  ...
  ('Citizen Kane', '18', '119', 'English'),
  ('12 Angry Men', '12', '96', 'English'),
  ...
  ('The Lord of the Rings: The Return of the King', '12', '201', 'English'),
  ('The Dark Knight', '12', '152', 'English'),
  ('The Godfather Part II', '18', '202', 'English'),
  ('Pulp Fiction', '18', '154', 'English'),
  ('Fight Club', '15', '139', 'English'),
  ('Psycho', '15', '109', 'English'),
  ('Metropolis', '18', '153', 'German'),
  ('Star Wars: Episode IV - A New Hope', 'U', '121', 'English'),
  ('The Lord of the Rings: The Fellowship of the Ring', 'U', '178', 'English'),
  ('The Matrix', '15', '136', 'English'),
  ('Les yeux sans visage', '15', '90', 'French'),
  ('Le Samouraï', '18', '105', 'French'),
  ('La règle du jeu', 'U', '110', 'French'),
  ('Les parapluies de Cherbourg', '18', '91', 'French'),
  ('Das Boot', '15', '149', 'German'),
  ('Der Baader Meinhof Komplex', '18', '150', 'German'),
  ('Nosferatu', '18', '94', 'German'),
  ('Untergang', '15', '156', 'German'),
  ('November', '15', '115', 'Estonian'),
  ('Nähtamatu võitlus', '15', '115', 'Estonian'),
  ('Tõde ja õigus', '15', '165', 'Estonian'),
  ('Nukitsamees', 'U', '75', 'Estonian');
